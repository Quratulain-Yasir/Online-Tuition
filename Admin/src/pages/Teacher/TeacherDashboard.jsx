...
const TeacherDashboard = () => {
  const { tToken, getDashData, dashData, setDashData , cancelLecture , confirmLecture } =
    useContext(TeacherContext);

const {dollarCurrency , slotDateFormate } = useContext(AppContext)
          ...
          <div className="flex items-center gap-2 bg-white p-4 w-56 rounded border-2 border-cyan-100 cursor-pointer hover:shadow-lg hover:border-cyan-700 hover:scale-105 transition-all duration-300">
            ...
            <div>
              <p className="font-semibold text-xl text-gray-600">
                ...
                {dollarCurrency}{" "}{dashData.earning}
              </p>
        ...
        <div className="flex-1 flex-col">
          ...
          <div className="pt-4 border border-t-0">
            {dashData.latestlecture.map((item, index) => (
              <div
                className="flex items-center px-6 py-3 gap-3 hover:bg-cyan-100"
                key={index}
              >
                <img
